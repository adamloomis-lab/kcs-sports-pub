...
export default function Terms() {
  return (
    <LegalLayout title="Terms of Service" updated="June 2026">
      ...
      <p>
        You may use the Site for your own personal, non-commercial purposes, to view our menu,
        hours, events, and location, and to contact us. You agree not to misuse the Site, interfere
        with its operation, or use it for any unlawful purpose.
      </p>

      <h2>Menu, Pricing &amp; Availability</h2>
      <p>
        Menu items, specials, events, and availability change often and are subject to change
        without notice. The menu shown on this Site is for general reference; please call{' '}
        <a href={company.phoneHref}>{company.phone}</a> to confirm current offerings and pricing.
      </p>

      <h2>Alcohol Service</h2>
      <p>
        We serve alcohol only to guests 21 and over with valid identification, and we reserve the
        right to refuse service. Drink specials described on this Site are subject to change and to
        applicable Ohio law.
      </p>
